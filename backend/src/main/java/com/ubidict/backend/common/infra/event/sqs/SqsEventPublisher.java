...
public class SqsEventPublisher implements EventPublisher {
    ...
    /**
     * <b>표준 큐에 보낸다</b>(D-53). {@code MessageGroupId}·{@code MessageDeduplicationId}는 붙이지 않는다 — FIFO 전용
     ...
     * {@code dedupeKey}에 유니크 제약을 걸어 재수신이 행을 늘리지 않게 한다(D-51).
     */
    @Override
