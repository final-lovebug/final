...
public enum DraftDictionaryErrorCode implements ErrorCode {
    ...
    DRAFT_DICTIONARY_CANDIDATE_FORM_REQUIRED(HttpStatus.BAD_REQUEST, "모든 후보어에 대표어가 있어야 합니다."),
    DRAFT_DICTIONARY_CANDIDATE_DEFINITION_REQUIRED(HttpStatus.BAD_REQUEST, "모든 후보어에 정의가 있어야 합니다."),
    ...
    DRAFT_DICTIONARY_EXTRACTION_INVALID_REQUEST(HttpStatus.BAD_REQUEST, "용어 추출 요청이 올바르지 않습니다."),
    DRAFT_DICTIONARY_EXTRACTION_NOT_FOUND(HttpStatus.NOT_FOUND, "용어 추출 작업을 찾을 수 없습니다."),
    DRAFT_DICTIONARY_EXTRACTION_ALREADY_RUNNING(HttpStatus.CONFLICT, "진행 중인 용어 추출 작업이 있습니다."),
