...
**결정 ID**는 `D-1`~`D-18`(초안·리뷰 3개 문서 전역 공유), `G-1`~`G-15`(큰 흐름), `D-19`~`D-32`(2026-09-10), `D-33`~`D-37`(2026-09-12 잔여 병렬화), `D-38`~`D-43`(2026-09-12 리뷰·초대 세션), `D-47`~`D-52`(2026-09-13 Notification 신설)를 쓴다. **새 결정은 `D-53`부터**다.
